...
const must = ['package.json','vercel.json','index.html','src/main.js','src/asset-system.js','src/style.css','public/assets/manifest.json','levels/level-01-mansion.json','ASSET_PLACEMENT.md'];
let ok = true;
